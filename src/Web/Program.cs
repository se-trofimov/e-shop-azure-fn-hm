...
builder.Services.AddDbContext<CatalogContext>(c =>
    c.UseInMemoryDatabase("CatalogDb"));
...
var orderItemsReserverFnUri = builder.Configuration["OrderItemsReserverFnUri"];
var orderItemsReserverFnKey = builder.Configuration["OrderItemsReserverFnKey"];
builder.Services.AddHttpClient("OrderItemsReserverClient", client =>
{
    client.BaseAddress = new Uri(orderItemsReserverFnUri);
    client.DefaultRequestHeaders.Add("x-functions-key", orderItemsReserverFnKey);
});
